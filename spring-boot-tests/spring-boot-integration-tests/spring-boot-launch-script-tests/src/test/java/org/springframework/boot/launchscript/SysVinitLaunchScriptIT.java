...
public class SysVinitLaunchScriptIT {
	...
	@ParameterizedTest(name = "{0} {1}")
	@MethodSource("parameters")
	public void launchWithMissingLogFolderGeneratesAWarning(String os, String version)
			throws Exception {
	...
	@ParameterizedTest(name = "{0} {1}")
	@MethodSource("parameters")
	public void launchWithMissingPidFolderGeneratesAWarning(String os, String version)
			throws Exception {
	...
	@ParameterizedTest(name = "{0} {1}")
	@MethodSource("parameters")
	public void launchWithSingleCommandLineArgument(String os, String version)
			throws Exception {
	...
	@ParameterizedTest(name = "{0} {1}")
	@MethodSource("parameters")
	public void launchWithMultipleCommandLineArguments(String os, String version)
			throws Exception {
	...
	@ParameterizedTest(name = "{0} {1}")
	@MethodSource("parameters")
	public void launchWithDoubleLinkSingleJavaOpt(String os, String version)
			throws Exception {
	...
	@ParameterizedTest(name = "{0} {1}")
	@MethodSource("parameters")
	public void launchWithUseOfStartStopDaemonDisabled(String os, String version)
			throws Exception {
	...
	@ParameterizedTest(name = "{0} {1}")
	@MethodSource("parameters")
	public void logFileOwnershipIsChangedWhenCreated(String os, String version)
			throws Exception {
		String output = doTest(os, version,
	...
	@ParameterizedTest(name = "{0} {1}")
	@MethodSource("parameters")
	public void logFileOwnershipIsUnchangedWhenExists(String os, String version)
			throws Exception {
		String output = doTest(os, version,
	...
	private String buildImage(String os, String version, DockerClient docker) {
		String dockerfile = "src/test/resources/conf/" + os + "/" + version
				+ "/Dockerfile";

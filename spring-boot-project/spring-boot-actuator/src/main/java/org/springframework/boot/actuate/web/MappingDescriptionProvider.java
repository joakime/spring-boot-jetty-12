 ...
 * via implementation-specific introspection of the application.
 *
...
public interface MappingDescriptionProvider {
	...
	/**
	 * Produce the descriptions of the mappings identified by this provider.
	 * @return the mapping descriptions
	 */
	Object describeMappings();

...
public class DispatcherHandlersMappingDescriptionProvider
	...
	private final Map<String, DispatcherHandler> dispatcherHandlers;

	public DispatcherHandlersMappingDescriptionProvider(
			Map<String, DispatcherHandler> dispatcherHandlers) {
	...
	public Map<String, List<DispatcherHandlerMappingDescription>> describeMappings() {
		...
		for (Entry<String, DispatcherHandler> entry : this.dispatcherHandlers
				.entrySet()) {
	...
	private static final class RouterFunctionMappingDescriptionProvider
		...
		public List<DispatcherHandlerMappingDescription> describe(
			...
			handlerMapping.getRouterFunction().accept(visitor);

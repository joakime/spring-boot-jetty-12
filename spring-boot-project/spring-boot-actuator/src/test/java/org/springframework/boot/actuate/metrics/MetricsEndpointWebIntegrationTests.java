...
public class MetricsEndpointWebIntegrationTests {
	...
	public void listNames(WebTestClient client) throws IOException {
	...
	@WebEndpointTest
	public void selectByName(WebTestClient client) {
	...
	@WebEndpointTest
	public void selectByTag(WebTestClient client) {
		client.get().uri(

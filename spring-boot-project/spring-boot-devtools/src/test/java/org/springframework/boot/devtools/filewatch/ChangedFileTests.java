...
public class ChangedFileTests {
	...
	public void sourceFolderMustNotBeNull() throws Exception {
		assertThatIllegalArgumentException().isThrownBy(
				() -> new ChangedFile(null, new File(this.tempDir, "file"), Type.ADD))
	...
	public void fileMustNotBeNull() throws Exception {
		assertThatIllegalArgumentException().isThrownBy(
				() -> new ChangedFile(new File(this.tempDir, "folder"), null, Type.ADD))
	...
	public void typeMustNotBeNull() throws Exception {
		assertThatIllegalArgumentException()
				.isThrownBy(() -> new ChangedFile(new File(this.tempDir, "file"),
						new File(this.tempDir, "folder"), null))
	...
	public void getFile() throws Exception {
		...
		ChangedFile changedFile = new ChangedFile(new File(this.tempDir, "folder"), file,
				Type.ADD);
	...
	public void getType() throws Exception {
		ChangedFile changedFile = new ChangedFile(new File(this.tempDir, "folder"),
				new File(this.tempDir, "file"), Type.DELETE);

...
public class JerseyManagementChildContextConfiguration {
	...
	private final ResourceConfig endpointResourceConfig;
	...
	public JerseyManagementChildContextConfiguration(
		...
		this.endpointResourceConfig = new ResourceConfig();
	}

	@Bean
	public ServletRegistrationBean<ServletContainer> jerseyServletRegistration() {
		return new ServletRegistrationBean<>(
				new ServletContainer(this.endpointResourceConfig), "/*");
	}

	@Bean
	public ResourceConfig endpointResourceConfig() {
		this.resourceConfigCustomizers.orderedStream().forEach(
				(customizer) -> customizer.customize(this.endpointResourceConfig));
		return this.endpointResourceConfig;
	}

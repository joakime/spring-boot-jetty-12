...
/**
 * {@link EnvironmentFactory} for {@link ApplicationServletEnvironment}.
 *
 * @author Andy Wilkinson
 */
class ApplicationServletEnvironmentFactory implements EnvironmentFactory {

	@Override
	public boolean supports(WebApplicationType webApplicationType) {
		return WebApplicationType.SERVLET == webApplicationType;
	}
	...
	public Supplier<StandardEnvironment> create() {
		return ApplicationServletEnvironment::new;
	}

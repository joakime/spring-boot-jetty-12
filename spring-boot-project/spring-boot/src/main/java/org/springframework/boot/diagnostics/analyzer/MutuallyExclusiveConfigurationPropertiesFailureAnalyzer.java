 ...
 */
class MutuallyExclusiveConfigurationPropertiesFailureAnalyzer extends
		AbstractFailureAnalyzer<MutuallyExclusiveConfigurationPropertiesException> implements EnvironmentAware {
	...
	private void appendDetails(StringBuilder message, MutuallyExclusiveConfigurationPropertiesException cause,
		...
		Set<String> configuredDescriptions = sortedStrings(descriptors, (descriptor) -> {
			return String.format("\t%s%s%n", descriptor.propertyName,

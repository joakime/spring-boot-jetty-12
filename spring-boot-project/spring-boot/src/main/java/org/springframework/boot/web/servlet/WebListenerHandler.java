...
class WebListenerHandler extends ServletComponentHandler {
	...
	protected void doHandle(Map<String, Object> attributes, AnnotatedBeanDefinition beanDefinition,
		...
		BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(StandardWebListenerRegistrar.class);
	...
	static class StandardWebListenerRegistrar implements WebListenerRegistrar {

		private final String listenerClassName;

		StandardWebListenerRegistrar(String listenerClassName) {

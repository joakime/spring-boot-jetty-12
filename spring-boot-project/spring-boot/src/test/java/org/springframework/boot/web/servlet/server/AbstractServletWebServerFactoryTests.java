...
public abstract class AbstractServletWebServerFactoryTests {
	...
	@Test
	void whenThereAreNoInFlightRequestsQuiesceReturnsTrueBeforePeriodElapses() throws Exception {
		AbstractServletWebServerFactory factory = getFactory();
		...
		assertThat(this.webServer.quiesce()).isTrue();
		long end = System.currentTimeMillis();
		assertThat(end - start).isLessThanOrEqualTo(30000);
	}

	@Test
	void whenARequestRemainsInFlightThenQuiesceReturnsFalseAfterPeriodElapses() throws Exception {
		AbstractServletWebServerFactory factory = getFactory();
		Quiesce quiesce = new Quiesce();
	...
	@Test
	void whenARequestCompletesAndTheConnectionIsClosedDuringQuiesceThenQuiesceReturnsTrueBeforePeriodElapses()
			throws Exception {
		AbstractServletWebServerFactory factory = getFactory();
		Quiesce quiesce = new Quiesce();
		quiesce.setPeriod(Duration.ofSeconds(30));
	...
	@Test
	void whenAnAsyncRequestRemainsInFlightThenQuiesceReturnsFalseAfterPeriodElapses() throws Exception {
		AbstractServletWebServerFactory factory = getFactory();
		Quiesce quiesce = new Quiesce();
		quiesce.setPeriod(Duration.ofSeconds(5));
		factory.setQuiesce(quiesce);
	...
	@Test
	void whenAnAsyncRequestCompletesAndTheConnectionIsClosedDuringQuiesceThenQuiesceReturnsTrueBeforePeriodElapses()
			throws Exception {
		AbstractServletWebServerFactory factory = getFactory();
		Quiesce quiesce = new Quiesce();
		quiesce.setPeriod(Duration.ofSeconds(30));
	...
	protected Future<Boolean> initiateQuiesce() {
		RunnableFuture<Boolean> future = new FutureTask<Boolean>(() -> this.webServer.quiesce());
	...
	protected void awaitQuiescing() {
		while (!this.isQuiescing()) {
			try {
				Thread.sleep(100);
			}
			catch (InterruptedException ex) {
	...
	protected abstract boolean isQuiescing();

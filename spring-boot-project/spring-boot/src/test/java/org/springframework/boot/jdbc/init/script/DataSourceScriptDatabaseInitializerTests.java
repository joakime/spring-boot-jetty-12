...
package org.springframework.boot.jdbc.init.script;
...
import org.springframework.boot.sql.AbstractScriptDatabaseInitializerTests;
...
class DataSourceScriptDatabaseInitializerTests extends AbstractScriptDatabaseInitializerTests {
	...
	protected int numberOfRows(String sql) {
		return new JdbcTemplate(this.dataSource).queryForObject("SELECT COUNT(*) from BAR", Integer.class);
	}

...
public class StringToEnumIgnoringCaseConverterFactoryTests {
	...
	public void convertFromStringToEnumWhenExactMatchShouldConvertValue(
		...
		assertThat(conversionService.convert("ONE", TestEnum.class))
				.isEqualTo(TestEnum.ONE);
		assertThat(conversionService.convert("TWO", TestEnum.class))
				.isEqualTo(TestEnum.TWO);
		assertThat(conversionService.convert("THREE_AND_FOUR", TestEnum.class))
	...
	public void convertFromStringToEnumWhenFuzzyMatchShouldConvertValue(
		...
		assertThat(conversionService.convert("three_and_four", TestEnum.class))
				.isEqualTo(TestEnum.THREE_AND_FOUR);
		assertThat(conversionService.convert("threeandfour", TestEnum.class))
				.isEqualTo(TestEnum.THREE_AND_FOUR);
		assertThat(conversionService.convert("three-and-four", TestEnum.class))
				.isEqualTo(TestEnum.THREE_AND_FOUR);
		assertThat(conversionService.convert("threeAndFour", TestEnum.class))
				.isEqualTo(TestEnum.THREE_AND_FOUR);
	}
	...
	public void convertFromStringToEnumWhenUsingNonEnglishLocaleShouldConvertValue(
		...
		try {
			...
			LocaleSensitiveEnum result = conversionService.convert(

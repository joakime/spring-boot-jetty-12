...
public class TestDatabaseAutoConfiguration {
	...
	private static class EmbeddedDataSourceFactory {
		...
		EmbeddedDataSourceFactory(Environment environment) {
			...
			((ConfigurableEnvironment) environment).getPropertySources().addFirst(new MapPropertySource("testDatabase",
					Collections.singletonMap("spring.datasource.schema-username", "")));
		}

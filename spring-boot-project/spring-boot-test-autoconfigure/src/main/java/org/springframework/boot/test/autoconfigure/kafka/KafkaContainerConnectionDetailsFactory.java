...
/**
 * {@link ContainerConnectionDetailsFactory} for {@link KafkaConnection @KafkaConnection}
 * annotated {@link KafkaContainer} fields.
 *
...
class KafkaContainerConnectionDetailsFactory
		extends ContainerConnectionDetailsFactory<KafkaConnection, KafkaConnectionDetails, KafkaContainer> {

	@Override
	protected KafkaConnectionDetails getContainerConnectionDetails(
			ContainerConnectionSource<KafkaConnection, KafkaConnectionDetails, KafkaContainer> source) {

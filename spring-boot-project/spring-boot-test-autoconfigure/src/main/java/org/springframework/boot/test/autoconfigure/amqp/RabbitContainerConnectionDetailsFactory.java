 ...
 * {@link RabbitConnection @RabbitConnection} annotated {@link RabbitMQContainer} fields.
 *
...
class RabbitContainerConnectionDetailsFactory
		extends ContainerConnectionDetailsFactory<RabbitConnection, RabbitConnectionDetails, RabbitMQContainer> {

	@Override
	protected RabbitConnectionDetails getContainerConnectionDetails(
			ContainerConnectionSource<RabbitConnection, RabbitConnectionDetails, RabbitMQContainer> source) {

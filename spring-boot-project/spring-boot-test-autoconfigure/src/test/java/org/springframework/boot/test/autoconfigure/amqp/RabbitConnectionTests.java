...
import org.springframework.boot.test.autoconfigure.amqp.RabbitConnectionTests.TestConfiguration;
...
/**
 * Tests for {@link RabbitConnection}.
 *
 * @author Andy Wilkinson
 */
@SpringBootTest(classes = TestConfiguration.class)
@Testcontainers(disabledWithoutDocker = true)
class RabbitConnectionTests {

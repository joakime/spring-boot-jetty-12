 ...
 */
@SpringBootTest(
		properties = { "spring.kafka.consumer.group-id=testGroup", "spring.kafka.consumer.auto-offset-reset=earliest" })
@EmbeddedKafka(controlledShutdown = true, topics = EmbeddedKafkaAutoConfigurationIntegrationTests.TEST_TOPIC)
@DirtiesContext
class EmbeddedKafkaAutoConfigurationIntegrationTests {
	...
	@Configuration
	@ImportAutoConfiguration({ KafkaAutoConfiguration.class, EmbeddedKafkaAutoConfiguration.class,

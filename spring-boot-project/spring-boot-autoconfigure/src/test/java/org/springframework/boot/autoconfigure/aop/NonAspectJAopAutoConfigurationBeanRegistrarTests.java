...
/**
 * Tests for {@link AopAutoConfigurationBeanRegistrar} without AspectJ.
 *
 * @author Andy Wilkinson
 */
@ClassPathExclusions("aspectjweaver*.jar")
class NonAspectJAopAutoConfigurationBeanRegistrarTests {

	private final ApplicationContextRunner contextRunner = new ApplicationContextRunner().withInitializer(
			(context) -> new AopAutoConfigurationBeanRegistrar().registerBeans(new StandardBeanRegistry(context)));

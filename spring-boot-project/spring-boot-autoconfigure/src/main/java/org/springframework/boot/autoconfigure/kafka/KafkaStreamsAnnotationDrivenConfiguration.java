...
class KafkaStreamsAnnotationDrivenConfiguration {
	...
	KafkaStreamsAnnotationDrivenConfiguration(KafkaProperties properties, Environment environment) {
	...
	KafkaStreamsConfiguration defaultKafkaStreamsConfig(Environment environment) {
		Map<String, Object> streamsProperties = applyEmbeddedBrokersIfAny(this.properties.buildStreamsProperties());

...
/**
 * Configuration for initializing an SQL database accessed via a JDBC {@link DataSource}.
 *
...
class JdbcInitializationConfiguration {
	...
	private static DataSource determineDataSource(DataSource dataSource, String username, String password) {
		if (StringUtils.hasText(username) && StringUtils.hasText(password)) {
			// TODO Create SimeplDriverDataSource with existing URL and driver and new
			// credentials

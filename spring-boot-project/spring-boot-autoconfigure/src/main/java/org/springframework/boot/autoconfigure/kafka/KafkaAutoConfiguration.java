...
public class KafkaAutoConfiguration {
	...
	public KafkaAutoConfiguration(KafkaProperties properties, Environment environment) {
	...
	public ConsumerFactory<?, ?> kafkaConsumerFactory() {
		Map<String, Object> consumerConfig = applyEmbeddedBrokersIfAny(this.properties.buildConsumerProperties());
	...
	public ProducerFactory<?, ?> kafkaProducerFactory() {
		Map<String, Object> producerConfig = applyEmbeddedBrokersIfAny(this.properties.buildProducerProperties());

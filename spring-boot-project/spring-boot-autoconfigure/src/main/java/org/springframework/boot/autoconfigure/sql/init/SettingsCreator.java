...
/**
 * Helpers class for creating {@link DatabaseInitializationSettings}.
 *
...
final class SettingsCreator {
	...
	static DatabaseInitializationSettings createFrom(SqlInitializationProperties properties) {
		...
		settings.setDdlScriptLocations(
				scriptLocations(properties.getDdlScriptLocations(), "schema", properties.getPlatform()));
		settings.setDmlScriptLocations(
				scriptLocations(properties.getDmlScriptLocations(), "data", properties.getPlatform()));

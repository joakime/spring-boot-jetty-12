...
public class WebFluxProperties {
	...
	public static class Format {
		...
		/**
		 * Date-time format to use. For instance, `yyyy-MM-dd HH:mm:ss`.
		 */
		private String dateTime;

		/**
		 * Whether the default date, time, and date-time formatters should use their
		 * corresponding ISO format.
		 */

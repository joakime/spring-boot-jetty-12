...
public class BuildInfoIntegrationTests {
	...
	@Test
	void buildInfoPropertiesAreGenerated() {
		new MavenBuild("build-info").execute(buildInfo((buildInfo) -> assertThat(buildInfo)
	...
	@Test
	void generatedBuildInfoIncludesAdditionalProperties() {
		new MavenBuild("build-info-additional-properties").execute(buildInfo((buildInfo) -> assertThat(buildInfo)
	...
	void generatedBuildInfoUsesCustomBuildTime() {
		new MavenBuild("build-info-custom-build-time").execute(buildInfo((buildInfo) -> assertThat(buildInfo)
	...
	@Test
	void buildInfoPropertiesAreGeneratedToCustomOutputLocation() {
		new MavenBuild("build-info-custom-file").execute(buildInfo("target/build.info",
	...
	@Test
	void whenBuildTimeIsDisabledIfDoesNotAppearInGeneratedBuildInfo() {
		new MavenBuild("build-info-disable-build-time").execute(buildInfo((buildInfo) -> assertThat(buildInfo)

...
using deferred or lazy bootstrapping, Spring Boot will automatically configure any
`LocalContainerEntityMangaerFactoryBean` beans to use the context's async task executor,
if any, as its bootstrap executor.

...
----
	...
	spring.flyway.dry-run-output= # File to which the SQL statements of a migration dry run should be output. Requires Flyway Pro or Flyway Enterprise.
	...
	spring.flyway.stream= # Whether to stream SQL migrarions when executing them. Requires Flyway Pro or Flyway Enterprise.
	...
	spring.flyway.undo-sql-migration-prefix= # File name prefix for undo SQL migrations. Requires Flyway Pro or Flyway Enterprise.
